...
class ConvertTest {
    ...
    fun `Test k suffix getReadableString with no specifying digitToKeep`() {
        Truth.assertThat(1000f.getReadableString()).isEqualTo("1k")
    }

    @Test
    fun `Test k suffix getReadableString with decimal and no specifying digitToKeep`() {
        Truth.assertThat(1234f.getReadableString()).isEqualTo("1.234k")
    }

    @Test
    fun `Test M suffix getReadableString with no specifying digitToKeep`() {
        Truth.assertThat(1000000f.getReadableString()).isEqualTo("1M")
    }

    @Test
    fun `Test M suffix getReadableString with decimal and no specifying digitToKeep`() {
        Truth.assertThat(1234567f.getReadableString()).isEqualTo("1.235M")
    }

    @Test
    fun `Test k suffix getReadableString with minus value and no specifying digitToKeep`() {
        Truth.assertThat((-1000).toFloat().getReadableString()).isEqualTo("-1k")
    }

    @Test
    fun `Test k suffix getReadableString with minus value and decimal and no specifying digitToKeep`() {
        Truth.assertThat((-1234).toFloat().getReadableString()).isEqualTo("-1.234k")
    }

    @Test
    fun `Test M suffix getReadableString with minus value and no specifying digitToKeep`() {
        Truth.assertThat((-1000000).toFloat().getReadableString()).isEqualTo("-1M")
    }

    @Test
    fun `Test M suffix getReadableString with minus value and decimal and no specifying digitToKeep`() {
        Truth.assertThat((-1234567).toFloat().getReadableString()).isEqualTo("-1.235M")
    }

    @Test
    fun `Test m suffix getReadableString with no specifying digitToKeep`() {
        Truth.assertThat(0.001f.getReadableString()).isEqualTo("1m")
    }

    @Test
    fun `Test m suffix getReadableString with decimal and no specifying digitToKeep`() {
        Truth.assertThat(0.001234f.getReadableString()).isEqualTo("1.234m")
    }

    @Test
    fun `Test μ suffix getReadableString with no specifying digitToKeep`() {
        Truth.assertThat(0.000001f.getReadableString()).isEqualTo("1μ")
    }

    @Test
    fun `Test μ suffix getReadableString with decimal and no specifying digitToKeep`() {
        Truth.assertThat(0.000001234567f.getReadableString()).isEqualTo("1.235μ")
    }

    @Test
    fun `Test m suffix getReadableString with minus value and no specifying digitToKeep`() {
        Truth.assertThat((-0.001).toFloat().getReadableString()).isEqualTo("-1m")
    }

    @Test
    fun `Test m suffix getReadableString with minus value and decimal and no specifying digitToKeep`() {
        Truth.assertThat((-0.001234).toFloat().getReadableString()).isEqualTo("-1.234m")
    }

    @Test
    fun `Test μ suffix getReadableString with minus value and no specifying digitToKeep`() {
        Truth.assertThat((-0.000001).toFloat().getReadableString()).isEqualTo("-1μ")
    }

    @Test
    fun `Test μ suffix getReadableString with minus value and decimal and no specifying digitToKeep`() {
        Truth.assertThat((-0.000001234567).toFloat().getReadableString()).isEqualTo("-1.235μ")
    }
