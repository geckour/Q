...
public interface ExoMediaDrm<T extends ExoMediaCrypto> {
  ...
  interface OnEventListener<T extends ExoMediaCrypto> {
     ...
     */
    void onEvent(ExoMediaDrm<? extends T> mediaDrm, @Nullable byte[] sessionId, int event, int extra, @Nullable byte[] data);
  }
  ...
  interface OnKeyStatusChangeListener<T extends ExoMediaCrypto> {
     ...
     */
    void onKeyStatusChange(ExoMediaDrm<? extends T> mediaDrm, byte[] sessionId, List<KeyStatus> exoKeyInformation, boolean hasNewUsableKey);
  }
   ...
   */
  KeyRequest getKeyRequest(byte[] scope, @Nullable List<SchemeData> schemeDatas, int keyType, @Nullable HashMap<String, String> optionalParameters)
